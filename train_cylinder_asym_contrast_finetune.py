...
import wandb
from utils.contrast_loss import PixelContrastLoss
...
def main(args):
    ...
    contrast_loss = PixelContrastLoss(max_samples=2048)
    ...
    while epoch < train_hypers['max_num_epochs']:
        ...
        for i_iter, (_, train_vox_label, train_grid, point_label, train_pt_fea) in enumerate(train_dataset_loader):
            ...
            loss = loss_ce + loss_lovasz + 0.001 * loss_contrast
            ...
            if global_iter % log_iter == 0:
                ...
                if len(loss_list) > 0:
                    ...
                    wandb.log({"train/contrast_loss": 0.001 * np.mean(contrast_loss_list)}, step=global_iter)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--config_path', default='config/semantickitti_contrast_finetune.yaml')
